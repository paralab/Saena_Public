...
//    bool    use_dcsrmultcsr = true;
    ...
    void set_parameters(int max_iter, double relative_tol, std::string smoother,
                        int preSmooth, int postSmooth, std::string PSmoother,
                        float connStrength, bool dynamic_lev, int max_lev, int float_lev,
                        double fil_thr, double fil_max, int fil_st, int fil_rate,
